...
# Load C++ generated skeletons (instead of computing with OpenCV Python)
# These were generated by running the C++ program
skeleton_opencv_zs_path = "debug_output/skeleton_cpp_zhangsuen.png"
skeleton_opencv_gh_path = "debug_output/skeleton_cpp_guohall.png"

if not os.path.exists(skeleton_opencv_zs_path):
    print("\n⚠️  エラー: C++で生成されたスケルトン画像が見つかりません")
    print(f"   {skeleton_opencv_zs_path}")
    print("\n先にC++版を実行してください:")
    print("   cd swagger-cpp/build")
    print("   ./generate_graph --map ../../maps/carter_warehouse_navigation.png --safety-distance 0.3")
    exit(1)

skeleton_opencv_zs = cv2.imread(skeleton_opencv_zs_path, cv2.IMREAD_GRAYSCALE)
skeleton_opencv_gh = cv2.imread(skeleton_opencv_gh_path, cv2.IMREAD_GRAYSCALE)
